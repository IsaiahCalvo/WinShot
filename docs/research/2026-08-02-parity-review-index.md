...
Protection: development remains on the isolated local branch. Main, GitHub, installer, and release state are unchanged. The installed app is the current review candidate and has a verified rollback backup.
...
| Annotation | Streamlined creation toolbar; emoji creation and Drag Me removed by product decision, while old emoji project data remains readable. Hierarchy, keyboard copy, project roundtrip, zoom, pin/copy, DPI and accessibility remain polished. | `docs/evidence/annotation/`; `docs/specs/2026-07-31-annotation-editor-slice.md` |
